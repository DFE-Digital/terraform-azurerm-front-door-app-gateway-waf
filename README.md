...
| <a name="input_certificates"></a> [certificates](#input\_certificates) | Customer managed certificates (.pfx) | <pre>list(<br>    object({<br>      contents : string,<br>      password : string<br>    })<br>  )</pre> | `[]` | no |
